...
def mask_detection():
    ...
    st.markdown('<h1 align="center">😷 Detection de masque et de validité des frames</h1>', unsafe_allow_html=True)
    activities = ["Image", "Webcam"]
    st.set_option('deprecation.showfileUploaderEncoding', False)
    st.sidebar.markdown("# Mask Detection on?")
    choice = st.sidebar.selectbox("Choisir parmi les options:", activities)

    if choice == 'Image':
        st.markdown('<h2 align="center">Detection sur Image</h2>', unsafe_allow_html=True)
